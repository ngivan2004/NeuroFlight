...
from model import DaysLeftPredictor
...
train_loader, test_loader = get_dataloaders(
    X_train, X_test, y_train[:, 1].unsqueeze(1), y_test[:, 1].unsqueeze(1), batch_size=BATCH_SIZE)

model = DaysLeftPredictor().to(DEVICE)
...
torch.save(model.state_dict(), 'days_left_predictor.pth')
print("Model training complete and saved as 'days_left_predictor.pth'")
